...
import { FETCH_ALL_RESTURANTS_ACTION, FETCH_ALL_RESTURANT_RESPONCE } from "../store.constants";
...
export const fetchAllResturantsSuccess = createAction(FETCH_ALL_RESTURANT_RESPONCE,props<{ payload: IRestaurant[] }>());